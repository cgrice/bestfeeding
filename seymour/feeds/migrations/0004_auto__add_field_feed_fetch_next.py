...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.fetch_next'
        db.add_column(u'feeds_feed', 'fetch_next',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.fetch_next'
        db.delete_column(u'feeds_feed', 'fetch_next')
    ...
    models = {
        u'feeds.feed': {
            ...
            'fetch_next': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
        ...
        u'feeds.page': {
            ...
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pages'", 'to': u"orm['feeds.Feed']"}),
